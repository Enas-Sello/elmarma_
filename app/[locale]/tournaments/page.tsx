...
import Home from '@/components/tournaments/home';
    ...
    <MainLayout>
      <main className="p-10 flex flex-col gap-8">
        ...
        <div className=" relative my-10  rounded bg-[#3D185C]">
          <div className="flex gap-10 items-center p-4 rounded  bg-[#3D185C]">
            ...
            <div className="flex  lg:mx-20 items-center text-mainWhite font-medium text-lg ">
              ...
              <div className=" flex  gap-1 md:gap-3 lg:gap-10 flex-wrap">
                {renderData.map(item => (
                  <div key={item.name}>
                    <Button
